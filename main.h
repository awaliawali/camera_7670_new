...
*/
    ...
    PA_0,PA_1,PA_3,         // VSYNC,HREF,WEN(FIFO)  
    PortC,0x07878000,   // PortIn data        p18(P0.26),p17(P0.25),p16(P0.24),p15(P0.23),p11(P0.18),p12(P0.17),p14(P0.16),p13(P0.15)
    PA_4,PA_5,PA_6        // RRST,OE,RCLK
